...
The aim of this assignment is to implement image compression using the \textbf{Truncated Singular Value Decomposition (SVD)} technique.  
The objective is to approximate a given grayscale image matrix by retaining only the top $k$ singular values and corresponding singular vectors, thereby achieving data compression with minimal loss of image quality.  

The assignment also aims to:
\begin{itemize}
    \item Understand the mathematical foundation of SVD and its role in low-rank matrix approximation.
    \item Implement the \textbf{Power Iteration with Deflation} algorithm to compute the top-$k$ singular values efficiently.
    \item Compare the performance of the implemented method with other SVD algorithms in terms of computational efficiency and accuracy.
...
\begin{figure}[H]
   \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/einstein_k_5.png} 
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/einstein_k_20.png} 
...
\begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/einstein_k_50.png} 
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/einstein_k_100.png} 
...
\begin{figure}[H]
   \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/globe_k_5.png} 
        \caption*{Reconstructed Image k=5}
        \label{fig:k5}
    \end{subfigure}
    \hfill
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/globe_k_20.png} 
        \caption*{Reconstructed Image  k=20}
        \label{fig:k20}
    \end{subfigure}
    \end{figure}
...
\begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/globe_k_50.png} 
        \caption*{Reconstructed Image  k=50}
        \label{fig:k5}
    \end{subfigure}
    \hfill
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/globe_k_100.png} 
        \caption*{Reconstructed Image  k=100}
        \label{fig:k20}
    \end{subfigure}
...
\begin{figure}[H]
   \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/greyscale_k_5.png} 
        \caption*{Reconstructed Image k=5}
        \label{fig:k5}
    \end{subfigure}
    \hfill
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/greyscale_k_20.png} 
        \caption*{Reconstructed Image  k=20}
        \label{fig:k20}
    \end{subfigure}
    \end{figure}
...
\begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/greyscale_k_50.png} 
        \caption*{Reconstructed Image  k=50}
        \label{fig:k5}
    \end{subfigure}
    \hfill
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figs/greyscale_k_100.png} 
        \caption*{Reconstructed Image  k=100}
        \label{fig:k20}
    \end{subfigure}
